...
\usepackage{cleveref}
% Permet a cleveref de reconnaitre les blocs de code (listings)
...
\input{chapters/03_methodologie_agile}
...
\appendix
\input{annexes/A_screenshots}
\input{annexes/B_burndowns}
\input{annexes/C_code}
